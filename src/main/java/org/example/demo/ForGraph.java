...
public class ForGraph extends Application {
    ...
    @Override
    public void init() {
        springContext = SpringApplication.run(ForGraph.class);
        fxmlLoader = new FXMLLoader(getClass().getResource("/views/graph1.fxml"));
